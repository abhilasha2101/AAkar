...
source_file = "backend/app/domain/whatsapp_service.py"
with open(source_file, "r") as f:
    content = f.read()

# We need to extract:
# send_text, send_template, download_media
# _simulated_replies, _sim_media_bytes, _IS_SIMULATION

service_content = """import httpx
import logging
...
with open("backend/app/domain/services/whatsapp_service.py", "w") as f:
